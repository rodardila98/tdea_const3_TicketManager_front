...
en el formulario */
export default function Input({ required, label, type = "text", placeholder, value, onChange, name }) {
  return (

    <div style={{ marginBottom: "10px" }}>
      {/* Si hay un label, lo mostramos. Si 'required' es true, agregamos el * rojo */}
      {label && (
      ...
      <input
        ...
        required={required} /* Activa la validación nativa del navegador */
        style={{
          width: '100%', // Asegura que ocupe todo el ancho disponible
          boxSizing: 'border-box', // Evita que el padding lo haga desbordarse
          marginTop: '6px',
          padding: '10px 14px',
          borderRadius: '8px',
